    ...
    <main>
      ...
      <section className="section-tight">
        <div className="wrap">
          ...
          <p className="kicker" style={{ marginTop: 44 }}>In full colour</p>
          <h2 className="title" style={{ marginBottom: 22 }}>Colour, sleeves and the ambitious stuff</h2>
          <div className="gallery">
            {COLOUR_GALLERY.map((g) => (
              <Link key={g.src} href={g.href} aria-label={`${g.label} tattoo designs`}>
                <Image src={g.src} alt={`${g.label} — full colour tattoo generated with InkOnce`} width={896} height={1200} />
                <span className="glabel">{g.label}</span>
              </Link>
            ))}
          </div>
          <p className="small faint" style={{ marginTop: 14 }}>
            Every design on this page was generated by InkOnce — and anything you see, you can make yourself.
          </p>
        </div>
      </section>
